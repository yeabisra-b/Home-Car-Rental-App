...
class TenantMessagesScreen extends StatefulWidget {
  ...
  const TenantMessagesScreen({super.key, this.currentUserId});
        ...
        itemBuilder: (context, index) {
          ...
          return Card(
            ...
            shape: RoundedRectangleBorder(
              ...
              side: BorderSide(
                color: isUnread ? Colors.teal.withOpacity(0.3) : Colors.grey.withOpacity(0.2),
              ),
            ),
            child: ListTile(
              ...
              trailing: Text(
                ...
                style: TextStyle(
                  color: isUnread ? Colors.teal : Colors.grey[500],
